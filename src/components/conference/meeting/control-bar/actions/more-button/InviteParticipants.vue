      ...
      <v-container fluid>
        <v-row>
          <v-col>
            <v-select
              ...
              return-object
              :label="
                $t('conference.meeting.controlBar.more.inviteParticipants.selectType')
              "
            >
            </v-select>
          </v-col>
        ...
        <v-row v-if="shouldShowNameEntry()">
          <v-col>
            <v-text-field
              :label="
                $t('conference.meeting.controlBar.more.inviteParticipants.enterName')
              "
            ></v-text-field>
          </v-col>
        </v-row>
        <v-row v-if="shouldShowCaseSelection()">
          <v-col>
            <v-select
              ...
              return-object
              :label="
                $t('conference.meeting.controlBar.more.inviteParticipants.selectCase')
              "
            ></v-select>
          </v-col>
        </v-row>
        ...
        <v-row>
          ...
          <v-col class="d-flex justify-end">
            <v-btn @click="generateLink()" elevation="0">{{
              $t("conference.meeting.controlBar.more.inviteParticipants.generateLink")
            }}</v-btn>
          </v-col>
        </v-row>
      </v-container>
