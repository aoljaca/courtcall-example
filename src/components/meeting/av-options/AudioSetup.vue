       ...
       <v-container fluid>
           ...
           <v-row>
               <v-col class="setup-height">
                   <call-me-audio-setup v-if="audioSetupMode === 'callMeSetup'"></call-me-audio-setup>
                   <call-in-audio-setup v-if="audioSetupMode === 'callInSetup'"></call-in-audio-setup>
                   <computer-audio-setup v-if="audioSetupMode === 'computerSetup'"></computer-audio-setup>
               </v-col>
           </v-row>
       </v-container>
    </div>
