<template>
    <div id="computerAudioSetup">
        <v-container>
            <v-row>
                <v-col cols="6">
                    <label class="font-weight-black" id="microphone-select-label" for="microphone-select">
                    ...
                    <v-btn color="primary">{{$t('avOptions.audioSetup.computerSetup.test')}}</v-btn>
                </v-col>
                <v-col v-if="hasSpeakerControl" cols="6">
                    <label class="font-weight-black" id="speaker-select-label" for="speaker-select">
