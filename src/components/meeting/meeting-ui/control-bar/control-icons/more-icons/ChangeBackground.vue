            ...
            <v-container fluid>
                <v-row>
                    <v-col class="d-flex justify-center">
                        <span class="font-weight-bold">{{$t('meetingUI.controlBar.more.changeBackground.selectBackground')}}</span>
                    ...
                    <v-col>
                            <v-radio-group class="background-radio" row v-model="selectedBackgroundOption">
                                ...
                                <template v-slot:label>
                                    <v-img :alt="background.backgroundUrl" max-height="100" max-width="100" :src="calculateBackgroundUrl(background)"></v-img>
                                </template>
                                </v-radio>
                            </v-radio-group>
                    </v-col>
